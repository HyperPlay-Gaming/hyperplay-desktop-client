...
export function refreshGameInfoFromHpRelease(
  ...
  return {
    ...
    extra: {
      ...
      storeUrl: `https://hyperplay-store-git-tech-apilaunch-hyperplay.vercel.app/game/${data.project_name}`
    },
    ...
    store_url: `https://hyperplay-store-git-tech-apilaunch-hyperplay.vercel.app/game/${data.project_name}`,
