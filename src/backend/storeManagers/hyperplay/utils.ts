...
export function refreshGameInfoFromHpRelease(
  ...
  return {
    ...
    extra: {
      ...
      storeUrl: `https://hyperplay-store-6wgwlqpev-hyperplay.vercel.app/game/${data.project_name}`
    },
    ...
    store_url: `https://hyperplay-store-6wgwlqpev-hyperplay.vercel.app/game/${data.project_name}`,
