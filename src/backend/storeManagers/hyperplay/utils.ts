...
export function refreshGameInfoFromHpRelease(
  ...
  return {
    ...
    extra: {
      ...
      storeUrl: `https://hyperplay-store-kx4d6geil-hyperplay.vercel.app/game/${data.project_name}`
    },
    ...
    store_url: `https://hyperplay-store-kx4d6geil-hyperplay.vercel.app/game/${data.project_name}`,
