...
const testUrl =
  'https://github.com/G7DAO/HyperPlay/releases/download/v2.3.9/HyperPlay-2.3.9.AppImage'
...
describe('getAssetDataFromDownload', () => {
  it('Success', async () => {
    ...
    await expect(getAssetDataFromDownload(testUrl)).resolves.toMatchObject({
      name: 'HyperPlay-2.3.9.AppImage',
      url: 'https://api.github.com/repos/G7DAO/HyperPlay/releases/assets/68579064'
    })
    expect(axios.get).toBeCalledWith(
      'https://api.github.com/repos/G7DAO/HyperPlay/releases/tags/v2.3.9'
    )
  })
