...
const signatureRequestTexts = {
  [TransactionState.INITIATED]: t(
    'hyperplayOverlay.signatureRequest.INITIATED',
    'Signature request pending'
  ),
  [TransactionState.PENDING]: '',
  [TransactionState.FAILED]: t(
    'hyperplayOverlay.signatureRequest.FAILED',
    'Signature interrupted'
  ),
  [TransactionState.CONFIRMED]: t(
    'hyperplayOverlay.signatureRequest.CONFIRMED',
    'Signature submitted'
  )
}
...
const txnRequestTexts = {
  [TransactionState.INITIATED]: t(
    'hyperplayOverlay.txnRequest.INITIATED',
    'Transaction request pending'
  ),
  [TransactionState.PENDING]: t(
    'hyperplayOverlay.txnRequest.PENDING',
    'Transaction submitted'
  ),
  [TransactionState.FAILED]: t(
    'hyperplayOverlay.txnRequest.FAILED',
    'Transaction interrupted'
  ),
  [TransactionState.CONFIRMED]: t(
    'hyperplayOverlay.txnRequest.CONFIRMED',
...
const chainTexts = {
  [TransactionState.INITIATED]: t(
    'hyperplayOverlay.chainRequest.INITIATED',
    'Custom network request'
  ),
  [TransactionState.PENDING]: '',
  [TransactionState.FAILED]: t(
    'hyperplayOverlay.chainRequest.FAILED',
    'Custom network canceled'
  ),
  [TransactionState.CONFIRMED]: t(
    'hyperplayOverlay.chainRequest.CONFIRMED',
...
const walletWatchTexts = {
  ...
  [TransactionState.PENDING]: '',
  [TransactionState.FAILED]: t(
    'hyperplayOverlay.walletWatch.FAILED',
    'Custom token request canceled'
  ),
  [TransactionState.CONFIRMED]: t(
    'hyperplayOverlay.walletWatch.CONFIRMED',
    'Custom token added'
  )
}
...
export const EXTENSION_NOTIFICATION: EXTENSION_NOTIFICATION_TYPE = {
  TITLE: t(
    'hyperplayOverlay.extensionNotification.TITLE',
  ...
  STATUS: t('hyperplayOverlay.extensionNotification.STATUS', 'pending')
}
