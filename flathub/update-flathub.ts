...
console.log(
  'releaseUploadResult stdout = ',
  releaseUploadResult.stdout?.toString()
)
console.log(
  'releaseUploadResult stderr = ',
  releaseUploadResult.stderr?.toString()
)
...
const releaseListTag = releasesTag?.elements?.[0].elements?.[0].elements?.find(
  (val) => val.name === 'ul'
)
